...
export const SpotQrCodeGenerator: React.FC<SpotQrCodeGeneratorProps> = ({
  ...
  return (
    ...
    >
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h4 className="font-bold text-sm sm:text-base text-white flex items-center gap-1.5">
                <span>QR Code Akses Detail Media Klien</span>
              </h4>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">
              Pindai QR ini dengan smartphone klien untuk membuka detail spesifikasi, foto, dan tarif sewa secara instan
            </p>
          </div>
        </div>
      ...
      {/* Mode Selector Tabs (Mobile Spec vs WA Chat vs WA Web) */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 p-1 bg-slate-950/80 border border-slate-800 rounded-xl text-xs font-semibold">
        ...
        <button
          ...
          title="QR langsung membuka tampilan spesifikasi lengkap di browser smartphone klien"
        >
          <Smartphone className="w-3.5 h-3.5" />
          <span>📱 Buka di HP Klien (Spec)</span>
        </button>
        ...
        <div className="flex-1 space-y-3 w-full text-xs">
          ...
          <div className="p-3 bg-slate-900/70 border border-slate-800/80 rounded-xl space-y-2">
            ...
            <ol className="text-[11px] text-slate-300 space-y-1 pl-1 list-decimal list-inside">
              ...
              <li>
                Arahkan kamera ke gambar QR Code di samping.
              </li>
              <li>
                {qrType === 'mobile_spec' ? (
                  <span>
                    Ketuk notifikasi tautan kuning yang muncul di layar untuk langsung melihat spesifikasi lengkap, foto, dan peta titik ini di browser ponsel.
                  </span>
                ) : (
                  <span>
                    Ketuk tautan untuk membuka chat WhatsApp resmi Suherman Reklame (<strong className="text-emerald-300">0878-2224-8975</strong>) dengan rincian titik terisi otomatis.
                  </span>
                )}
              </li>
            </ol>
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1">
            ...
            <button
              ...
              title="Buka langsung tautan QR ini di tab baru browser untuk simulasi tampilan ponsel"
            >
            ...
            <button
              ...
              title="Unduh file gambar QR Code beresolusi tinggi (PNG) untuk dicetak pada brosur / kartu nama"
            >
